...
public:
	...
	Tree(const std::initializer_list<T>& arr) :Tree()
	{
...
//template<typename T> typedef void (*func)(Tree<T>& tree, int n);
//template<typename T> void measure(Tree<T>& tree, int n, func function)
//{
//	clock_t start = clock();
//	function(tree, n);
//	clock_t end = clock();
